...
/**
    Returns the directory the application uses to store the Core Data store file. This code uses a directory named "DoThings" in the user's Library directory.
 */
